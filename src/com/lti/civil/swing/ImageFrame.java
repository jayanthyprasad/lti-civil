...
/**
 * Simple JFrame to display images.
	...
	public class ImageComponent extends JComponent
	{
		...
		public synchronized void paint(Graphics g)
		{
			...
			if (image != null) {
				do {
					if (vImage == null) {
						vImage = createVolatileImage(image.getWidth(this), image.getHeight(this));
					}
					Graphics graphics = vImage.getGraphics();
					graphics.drawImage(image, 0, 0, this);

				} while (vImage.contentsLost());
				g.drawImage(vImage, 0, 0, getWidth(), getHeight(), 0, 0, image.getWidth(this), image.getHeight(this), this);
			}
		}
