...
{
//	L"/dev/video", // TODO: having this in here somehow prevents us from opening both video0 and video1.  Not sure why.
	L"/dev/video0",
	L"/dev/video1",
	L"/dev/video2",
	L"/dev/video3",
...
CaptureStream *V4L2CaptureSystem::openCaptureDeviceStream(const wchar_t *deviceId, int output, int input) /*throws CaptureException*/
{
	if (output != 0) {
